    ...
    return (
        <>
            ...
            >
                ...
                {/* Close Button */}
                <motion.button
                    className="absolute top-20 sm:top-20 md:top-30 right-10 sm:right-20 md:right-10 
                              p-2 rounded-full bg-gray-200/80  hover:bg-gray-300/80 
                              text-2xl sm:text-sm backdrop-blur-sm cursor-pointer z-200"
                    onClick={onClose}
