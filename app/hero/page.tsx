  ...
  return (
    <section className="w-full h-screen overflow-hidden md:overflow-visible flex flex-col items-center justify-center relative">
      <Floating sensitivity={-0.5} className="h-full">
        <FloatingElement
          depth={0.5}
          className="top-[20%] left-[2%] md:top-[25%] md:left-[5%]"
        >
          <motion.img
        ...
        <FloatingElement
          depth={1}
          className="top-[10%] left-[8%] md:top-[9%] md:left-[11%]"
        >
          <motion.img
        ...
        <FloatingElement
          depth={4}
          className="top-[70%] left-[6%] md:top-[80%] md:left-[8%]"
        >
          <motion.img
        ...
        <FloatingElement
          depth={2}
          className="top-[10%] left-[70%] md:top-[2%] md:left-[83%]"
        >
          <motion.img
        ...
        <FloatingElement
          depth={1}
          className="top-[70%] left-[70%] md:top-[68%] md:left-[83%]"
        >
          <motion.img
      ...
      <div className="flex flex-col justify-center items-center w-[370px] sm:w-[450px] md:w-[500px] lg:w-[700px] z-50 pointer-events-auto">
        <motion.h1
        ...
        <div className="flex flex-row justify-center space-x-4 items-center mt-10 sm:mt-16 md:mt-20 lg:mt-20 text-xs">
          ...
          >
            <Link href="mailto:sandeeptech20023@gmail.com">★ Hire Me</Link>
          </motion.button> */}
        </div>
      </div>
    </section>
